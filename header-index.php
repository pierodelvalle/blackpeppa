...
<body>
	<div class="loader">
		<img src="<?php echo get_template_directory_uri();?>/img/loader.svg" alt="Cargando...">
	</div>
	<header class="header header-index">	
		<div class="container">
			<div class="container-wrapper">
				<a class="header-img full no-tablet yes-phone" href="/#inicio"><img height="65" width="250" src="<?php echo get_template_directory_uri(); ?>/img/blackpeppa_logo_B.svg" alt="Black Peppa"></a>
